...
if __name__ == '__main__':
    ...
    opt = Optimizer(onnx.load('./clip_fp16.onnx'))
    ...
    onnx.save(onnx_opt_graph, "./vae_decoder_optimize.onnx")
    opt = Optimizer(onnx.load('./controlunet.onnx',load_external_data=False))
    opt.cleanup()
    opt.fold_constants()
    opt.infer_shapes()
    onnx_opt_graph = opt.cleanup(return_onnx=True)
    onnx.save(onnx_opt_graph, "./controlunet_optimize.onnx")